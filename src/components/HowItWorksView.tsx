        ...
        <div className="min-h-screen bg-slate-950 pt-4 pb-16 px-4 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                <div className="mt-16 border-t border-white/10 pt-10">
                    <div className="bg-slate-900/40 border border-slate-700/50 rounded-2xl p-6 md:p-8 space-y-4">
                        <h3 className="text-xs font-black uppercase tracking-widest text-gray-500">Disclaimer</h3>
                        <div className="space-y-3 text-xs text-gray-500 leading-relaxed">
                            <p>
                                FantasyPremierWolf is an independent AI strategy tool and is not affiliated with, endorsed by, or connected to the Premier League, Fantasy Premier League, or any football club.
                            </p>
                            <p>
                                The Wolf analyses historical data, current form, fixture difficulty, and statistical trends to generate recommendations. <strong className="text-gray-400">Past performance and statistics do not guarantee future results.</strong> Football is inherently unpredictable — injuries, suspensions, weather, managerial decisions, and other factors can render any recommendation obsolete at any time.
                            </p>
                            <p>
                                The Wolf cannot predict the future. All analysis, transfer suggestions, captain picks, and chip recommendations are generated by an AI model and represent probabilistic suggestions only — not guarantees of points or rank improvement. You should apply your own judgement before acting on any recommendation.
                            </p>
                            <p>
                                Auto-Pilot executes transfers automatically on your behalf based on The Wolf's analysis. By enabling Auto-Pilot you accept full responsibility for any transfers made to your FPL team, including any points hits incurred. FantasyPremierWolf accepts no liability for rank changes, points lost, or decisions made as a result of using this tool.
                            </p>
                            <p>
                                Credits are consumed when an analysis is generated, regardless of whether the recommendations are acted upon. No refunds are provided for analyses already generated.
                            </p>
                            <p>
                                Use of this tool is at your own risk. For full terms, see our <a href="/faq" className="text-gray-400 hover:text-white underline underline-offset-2 transition-colors">FAQ</a>.
                            </p>
                        </div>
                    </div>
                </div>
